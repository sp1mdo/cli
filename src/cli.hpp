...
namespace cli
{
    ...
    inline constexpr char UNIX_NEWLINE_CHAR{0x0A};
    inline constexpr char UNIX_BACKSPACE_CHAR{0x7F};

    inline constexpr char PICO_NEWLINE_CHAR{0x0D};
    inline constexpr char PICO_BACKSPACE_CHAR{0x08};

    inline constexpr size_t CLEAR_BACK_CHARS{20};

    inline constexpr std::string_view UP_KEY1{"\x1b\x5b\x41"};
    inline constexpr std::string_view UP_KEY2{"\x1b\x4f\x41"};
    inline constexpr std::string_view DOWN_KEY1{"\x1b\x5b\x42"};
    inline constexpr std::string_view DOWN_KEY2{"\x1b\x4f\x42"};
    inline constexpr std::string_view LEFT_KEY1{"\x1b\x5b\x44"};
    inline constexpr std::string_view LEFT_KEY2{"\x1b\x4f\x44"};
    inline constexpr std::string_view RIGHT_KEY1{"\x1b\x5b\x43"};
    inline constexpr std::string_view RIGHT_KEY2{"\x1b\x4f\x43"};

    inline constexpr std::string_view F1_KEY1{"\x1b\x4f\x50"};
    inline constexpr std::string_view F1_KEY2{"\x1b\x5b\x31\x31\x7e"}; // done
    inline constexpr std::string_view F2_KEY1{"\x1b\x4f\x51"};
    inline constexpr std::string_view F2_KEY2{"\x1b\x5b\x31\x32\x7e"};
    inline constexpr std::string_view F3_KEY1{"\x1b\x4f\x52"};
    inline constexpr std::string_view F3_KEY2{"\x1b\x5b\x31\x33\x7e"};
    inline constexpr std::string_view F4_KEY1{"\x1b\x4f\x53"};
    inline constexpr std::string_view F4_KEY2{"\x1b\x5b\x31\x34\x7e"};
    inline constexpr std::string_view F5_KEY1{"\x1b\x5b\x31\x36\x7e"};
    inline constexpr std::string_view F5_KEY2{"\x1b\x5b\x31\x35\x7e"};
    inline constexpr std::string_view F5_KEY3{"\x1b\x4f\x54"};
    inline constexpr std::string_view F6_KEY1{"\x1b\x5b\x31\x37\x7e"};
    inline constexpr std::string_view F6_KEY2{"\x1b\x4f\x55"};
    inline constexpr std::string_view F7_KEY1{"\x1b\x5b\x31\x38\x7e"};
    inline constexpr std::string_view F7_KEY2{"\x1b\x4f\x56"};
    inline constexpr std::string_view F8_KEY1{"\x1b\x5b\x31\x39\x7e"};
    inline constexpr std::string_view F8_KEY2{"\x1b\x4f\x57"};
    inline constexpr std::string_view F9_KEY1{"\x1b\x5b\x32\x30\x7e"};
    inline constexpr std::string_view F9_KEY2{"\x1b\x4f\x58"};
    inline constexpr std::string_view F10_KEY1{"\x1b\x5b\x32\x31\x7e"};
    inline constexpr std::string_view F10_KEY2{"\x1b\x4f\x59"};
    inline constexpr std::string_view F11_KEY1{"\x1b\x5b\x32\x33\x7e"};
    inline constexpr std::string_view F11_KEY2{"\x1b\x4f\x5a"};
    inline constexpr std::string_view F12_KEY1{"\x1b\x5b\x32\x34\x7e"};
    inline constexpr std::string_view F12_KEY2{"\x1b\x4f\x5b"};

    inline constexpr char dummy_char = 0x05;

    inline constexpr size_t history_size{20};
    ...
    {
    public:
        Prompt(const std::string &name) : m_SpecialCharacterState(false), m_Name(name), m_HistoryIndex(-1), m_oldInput("dummy")
        {
            setNonCanonicalMode();
            updateAuxMenu("");
